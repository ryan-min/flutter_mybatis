...
First release on pub.dev. No code changes from 1.1.3 — the install instructions
now point at pub.dev rather than telling you to depend on the git repository,
which is what the earlier versions had to say.
