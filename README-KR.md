...
아직 pub.dev에 게시하지 않았습니다. git으로 설치하십시오.
...
`flutter_mybatis_generator`는 매퍼 코드 생성을 쓸 때만 필요합니다. 없이도
`Mapper`를 직접 상속해 쓸 수 있습니다.
...
`1.1.2`는 위에 문서화된 공개 API가 안정적임을 뜻합니다. 로드맵 항목(중첩
