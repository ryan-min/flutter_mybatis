...
Not on pub.dev yet. Install from git:
...
only 3.0). It is only needed if you want generated mappers.
...
`1.1.3` means the public API above is stable. Everything on the roadmap
