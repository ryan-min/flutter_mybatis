...
''')).code;
    ...
    test('파라미터가 없으면 빈 Map을 넘긴다 (const 아님: 생성키 되돌림)', () async {
      final generated = (await build('''
import 'package:flutter_mybatis/flutter_mybatis.dart';
part 'person_mapper.g.dart';
...
''')).code;
      ...
      // const 면 useGeneratedKeys 가 키를 되돌려 쓸 때 예외가 난다.
      expect(generated, hasCode('<String, dynamic>{}'));
      expect(generated, isNot(contains('const <String, dynamic>{}')));
    });
  });
