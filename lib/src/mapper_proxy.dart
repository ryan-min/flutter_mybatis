...
///
///   Future<List<Map<String, dynamic>>> selectGrpF0102List(Map p) => selectList('selectGrpF0102List', p);
///   Future<Map<String, dynamic>?> selectGrpF0102Detail(Map p) => selectOne('selectGrpF0102Detail', p);
///   Future<int> insertGrpF0106(Map p) => insert('insertGrpF0106', p);
///   Future<int> updateGrpF0108(Map p) => update('updateGrpF0108', p);
///   Future<int> deleteGrpF0109(Map p) => delete('deleteGrpF0109', p);
/// }
/// ```
...
class MapperRegistry {
  ...
  T getMapper<T>() {
    ...
    if (mapper == null) {
      throw StateError('Mapper가 등록되지 않았습니다: $T');
    }
    return mapper as T;
  }
