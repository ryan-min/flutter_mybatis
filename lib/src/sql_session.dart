...
class SqlSession {
  ...
  Future<int> selectCount(
    ...
    final value = result[key] ??
        // "SELECT COUNT(*) FROM T" with no alias yields a column literally
        // named "COUNT(*)". Falling back to the single column is friendlier
        // than silently returning 0.
        (result.length == 1 ? result.values.first : null);
